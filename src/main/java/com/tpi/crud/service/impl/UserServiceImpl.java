...
import com.tpi.crud.dao.api.UserDaoAPI;
import com.tpi.crud.dto.UserRegistrationDto;
import com.tpi.crud.entity.Role;
...
public class UserServiceImpl implements UserServiceAPI {
    ...
    private UserDaoAPI userRepository;

    @Autowired
    private BCryptPasswordEncoder passwordEncoder;

    public UserServiceImpl(UserDaoAPI userRepository) {
        super();
